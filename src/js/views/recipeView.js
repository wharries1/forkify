...
class RecipeView extends View {
  ...
  _message = 'Your Recipe Has Been Deleted';
  ...
  addHandlerRemove(handler){
    this._parentElement.addEventListener('click', function(e){
      ...
      if(confirm('Are you sure you want to permanently delete this recipe?') == true){
      handler();
      } else 
      return;
    })
  ...
  <div class="recipe__details">
    ...
    <div class="recipe__user-generated btn--round ${this._data.key ? '' : 'hidden'}">
      <svg>
